...
struct cur_rock_rq {
       struct page *cur_dst;	//current destination page
       struct page *pre_dst;	//pre destination page
       struct page *cur_src;	//current source page
       struct page *pre_src;	//pre destination page
